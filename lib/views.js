...
#map{height:58vh;min-height:440px;width:100%;background:#A8D5E6}
...
.panel{position:relative;z-index:5;background:#fff;border-radius:26px 26px 0 0;margin-top:-46px;padding:26px 0 8px;box-shadow:0 -10px 30px rgba(0,0,0,.07)}
...
function load(){
 var map=L.map('map',{zoomControl:false,attributionControl:false,scrollWheelZoom:false}).setView([54.3,-2.6],6);
