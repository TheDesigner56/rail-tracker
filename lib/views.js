...
function buyHTML(d){if(!d||d.mode==='london'||!d.from||!d.to)return '';
 ...
 var tl='https://www.thetrainline.com/train-times/'+slug(fn)+'-to-'+slug(tn);
 ...
 var rows=[['🚆','Trainline','Book ›',tl],['🚉','National Rail','Book ›',nr],['💷','TrainPal','Compare ›','https://www.mytrainpal.com/'],['🌐','Trip.com','Compare ›','https://uk.trip.com/trains/']];
